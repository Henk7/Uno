...
| --------------------- | ------- | ------- | ------- | --- |
| _tapped events_
| `Tapped`              | Yes     | Yes (1) | Yes     | [Documentation](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.tapped) |
| `DoubleTapped`        | Yes     | Yes (1) | No      | [Documentation](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.doubletapped) |
| _focus events_
...
A special property named `RoutedEventsBubblingInUno` is used to determine how properties are propagated through
...
## Details on implementations of each events
### Tapped
(TODO)
...
or reference the element where the event crossed the _native-to-managed_ boundary.
